...
export function SlidingLogoMarquee({
  ...
  const blurDivs = Array.from({ length: animationSteps }, (_, index) =>
    _jsx("div", { style: { "--index": index } }, index)
  );
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          showGridBackground && _jsx("div", { className: "" }),
          _jsx("div", {
            ...
            children: _jsxs("div", {
              className: "sliding-marquee-inner",
              children: [
                enableBlur &&
                  _jsx("div", {
                    className:
                      "sliding-marquee-blur sliding-marquee-blur--left",
                    children: blurDivs,
                  }),
                _jsx("ul", {
                ...
                enableBlur &&
                  _jsx("div", {
                    className:
                      "sliding-marquee-blur sliding-marquee-blur--right",
                    children: blurDivs,
                  }),
              ],
            }),
          ...
          showControls &&
            _jsx("button", {
              ...
              children: isPlaying ? _jsx(Pause, {}) : _jsx(Play, {}),
            }),
        ],
      }),
    ],
